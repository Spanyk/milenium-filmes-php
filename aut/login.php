...
.overlay {
	...
	background: linear-gradient(64deg, rgb(39, 43, 44) 3.36%, rgb(241, 60, 43) 100.00%);
	background: linear-gradient(to right, 64deg, rgb(39, 43, 44) 3.36%, rgb(241, 60, 43) 100.00%);
...
<div class="container" id="container">
    <div class="form-container sign-up-container">
        <form method="post">
            ...
            <input class="input" type="text" placeholder="Email" id="user_email"/>
            <input class="input" type="email" placeholder="Password" id="Password"/>
            <input class="input" type="password" placeholder="Confirm Password" id="conf_password" />
